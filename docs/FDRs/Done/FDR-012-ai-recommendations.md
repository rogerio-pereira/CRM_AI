...
1. **Recommendation Agent** generates: company summary, pain points, opportunity analysis, and general outreach strategy. When a website opening exists, lead with website work; treat lead generation, content, email, and automation as follow-on until `revert-later-website-first` is closed.
