...
3. Notes are included as context for **Refresh AI insights** (Recommendation Agent and the first-contact email job that follows) and for Proposal Assistant recommendations ([FDR-013](../ToDo/FDR-013-proposal-assistance.md)).
...
- [x] `opportunity_notes` (or equivalent) persistence with opportunity_id, user_id, body, timestamps.
- [x] Timeline UI on opportunity detail.
- [x] Notes available to proposal assistance as context.
- [x] Tests cover create/list authorization.
