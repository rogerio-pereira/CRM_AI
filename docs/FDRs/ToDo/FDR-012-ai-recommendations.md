...
**Feature:** 12  
**Status:** Approved  
**Reference:** [12 AI recommendations and insights](../../05%20-%20Feature%20List.md#f12-ai-recommendations), [ADR-011](../../ADRs/ADR-011-human-approval-commercial-actions.md), [ADR-013](../../ADRs/ADR-013-dark-mode-design-system.md)

---

## How it works

1. **Recommendation Agent** generates: company summary, pain points, opportunity analysis, outreach strategy.
2. Persist on lead/opportunity AI fields; render **AI Suggestion Panel** in detail modals (border `ai`, badge “AI Insight”).
